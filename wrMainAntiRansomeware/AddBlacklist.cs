...
{
    public partial class AddBlacklist : Form
    {
        ...
        private void AddBlacklist_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                Form1.ad2b = null;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                File.WriteAllText("..\\blacklistsigns.txt", textBox1.Text.Trim('\r', '\n'), new UTF8Encoding(false));
        ...
        private void AddBlacklist_Load(object sender, EventArgs e)
        {
            try
            {
                AForm = this;
                textBox1.Text = File.ReadAllText("..\\blacklistsigns.txt");
                button1.Select();
            }
            catch(Exception em){ProductKeyForm.FAppendAllText("wrlog2.txt.wrdb", new StackFrame(1, true).GetFileName() + " " + new StackFrame(1, true).GetFileLineNumber() + Environment.NewLine + em.ToString() + Environment.NewLine + DateTime.Now.ToString() + Environment.NewLine);}
        ...
        private void AddBlacklist_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Hide();
        }
